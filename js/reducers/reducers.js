...
const initialState = {
  ...
  ewsData:{
    ...
    eWSRating:'',								
    remarks:'',								    
    isRetentionActionsPlanned:'',				
    retentionActionsPlanned:'',				
    selecttheRetentionActions:'',				
    plannedSuccessor:'',						
    activitiesPlannedforSuccessor:'',			
    percentageofSuccessorReadiness:'',		
    successorReadinessStatus:'',				
    successorReadyDate:'',					
    isSuccessorTravelReady:'',				
    travelReadyDate:''						
  },
