...
export function ewsDataAction() {
    console.log("inside AppActions >>> ewsDataAction");
    return (dispatch) => {
      auth.findAllEwsData((success, response) => {
        console.log(response);
        console.log("inside AppActions >>> findAllEwsData")
        if (success === true) {
          console.log("inside AppActions >>> findAllEwsData >>> "+response);
          dispatch(setEwsData(response));
        } else {
          console.log(response.err)
          //dispatch(setErrorMessage(errorMessages.GENERAL_ERROR));
        }
...
export function setEwsData(newState){
    console.log("***************************** inside setbaseskilldata ")
    return { type: SET_EWS_DATA, newState}
}
