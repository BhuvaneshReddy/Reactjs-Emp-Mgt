                ...
                <div className="container__profile-data">
                    <div className="profile-data">                  
                        <BootstrapTable ref='table' data={profileData.objects} selectRow={selectRowProp} 
                          ...
                          >
                            <TableHeaderColumn dataField='firstName' width='150px' dataAlign='center'>FirstName</TableHeaderColumn>
                            <TableHeaderColumn dataField='lastName' width='150px' dataAlign='center'>LastName</TableHeaderColumn>
                            <TableHeaderColumn dataField='project' width='150px' dataAlign='center'>Project</TableHeaderColumn>
                            <TableHeaderColumn dataField='releaseDate' width='150px' dataAlign='center'>Release Date</TableHeaderColumn>
                            <TableHeaderColumn dataField='primarySkills' width='150px' dataAlign='center'>Primary skills</TableHeaderColumn>
                            <TableHeaderColumn dataField='secondarySkills' width='150px' dataAlign='center'>Secondary skills</TableHeaderColumn>
                            <TableHeaderColumn dataField='yearsOfExperience' width='150px'dataAlign='center'>Years of experience</TableHeaderColumn>
                            <TableHeaderColumn dataField='trainings' width='150px' dataAlign='center'>Trainings</TableHeaderColumn>
                            <TableHeaderColumn dataField='qualification' width='150px' dataAlign='center'>Qualification</TableHeaderColumn>
                            <TableHeaderColumn dataField='mobileNo' width='150px' dataAlign='center'>Mobile number</TableHeaderColumn>
                            <TableHeaderColumn dataField='email' isKey={ true } width='150px' dataAlign='center'>Email</TableHeaderColumn>
                        </BootstrapTable>
